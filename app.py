...
def main():
    ...
    st.write("1. Upload your PDF file using the file uploader.")
    ...
    with st.sidebar:
        ...
        uploaded_files = st.file_uploader("Upload your PDF file and Click on the Submit & Process Button", accept_multiple_files=True, type=["pdf", "pptx"])
